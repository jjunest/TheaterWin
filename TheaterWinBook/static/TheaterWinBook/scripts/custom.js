...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaScope = "/static/TheaterWinBook/";
    var pwaLocation = "/static/TheaterWinBook/_service-worker.js";
    ...
    function init_template(){
        ...
        highlightData.forEach(el => el.addEventListener('click', e =>{
            ...
            loadHighlight.href = '/static/TheaterWinBook/styles/highlights/highlight_' + highlight +'.css';
        ...
        if(rememberHighlight){
            ...
            loadHighlight.className = "page-highlight";
            loadHighlight.type = "text/css";
            loadHighlight.href = '/static/TheaterWinBook/styles/highlights/highlight_' + rememberHighlight +'.css';
            ...
            loadHighlight.className = "page-highlight";
            loadHighlight.type = "text/css";
            loadHighlight.href = '/static/TheaterWinBook/styles/highlights/highlight_' + defaultHighlight[1] +'.css';
            if(!document.querySelectorAll('.page-highlight').length){
                document.getElementsByTagName("head")[0].appendChild(loadHighlight);
